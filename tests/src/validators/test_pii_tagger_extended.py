...
def test_sanitize_typed_merges_overlapping_prefers_priority():
    """Test overlapping spans prefer higher priority type."""
    jwt = "aaaa.bbbb.cccc"
    text = f"token {jwt}"
    res = sanitize_typed(text)
...
def test_sanitize_typed_detects_name_and_rnokpp():
    """Test detection of names and RNOKPP codes."""
...
def test_sanitize_typed_handles_zero_width_and_noise():
    """Test handling of zero-width characters and noise."""
...
def test_sanitize_typed_detects_private_key_and_jwt():
    """Test detection of private keys and JWT tokens."""
    pk = (
        "-----BEGIN PRIVATE KEY-----"
