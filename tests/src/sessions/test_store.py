...
def test_get_or_create_new(mock_settings):  # pylint: disable=unused-argument
    """Test get or create new session."""
...
def test_save_and_load(mock_settings):  # pylint: disable=unused-argument
...
def test_load_not_found(mock_settings):  # pylint: disable=unused-argument
    """Test load not found raises error."""
