...
def test_create_category(content_manager, mock_settings):  # pylint: disable=redefined-outer-name,unused-argument
...
def test_add_template(content_manager, mock_settings):  # pylint: disable=redefined-outer-name
...
@pytest.mark.usefixtures("mock_categories_data")
def test_add_field(content_manager, mock_settings):  # pylint: disable=redefined-outer-name
    """Test adding a field."""
