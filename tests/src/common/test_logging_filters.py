...
def test_pii_redaction_filter_replaces_message():
    """Test PII redaction filter replaces message."""
    filt = PiiRedactionFilter()
    record = logging.LogRecord(
        "test", logging.INFO, "", 0,
        "IBAN UA21 3223 1300 0002 6007 2335 6600 1", args=(), exc_info=None
    )
...
def test_color_formatter_preserves_level():
    """Test color formatter preserves level."""
